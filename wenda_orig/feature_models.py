# This code is from from https://github.com/PfeiferLabTue/wenda, adapted from
...
class FeatureGPR(FeatureModel):
    ...
    def predict_var(self, x_new):
        '''
        Returns variances from the FeatureGPR model.
        ...
        if not self._fitted:
            raise RuntimeError("Cannot predict from model before calling fit()!")
        return self._model.predict(x_new)[1]
